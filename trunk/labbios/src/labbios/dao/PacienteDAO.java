...
public class PacienteDAO extends DatabaseUtil {
	...
	public Paciente procurarPacientePorNome(String pacienteNome) throws ClassNotFoundException, SQLException
	{
		PreparedStatement ps = getPreparedStatement("Select * from PACIENTE where PACIENTE_NOME="+pacienteNome);
