...
public class GrupoExameDAO extends DatabaseUtil{
	...
	public boolean adicionarGrupoExame(GrupoExame grupoExame) throws ClassNotFoundException, SQLException
	{
		...
		PreparedStatement ps = getPreparedStatement("Insert into GRUPO_EXAME set GRUPO_EXAME_ABREV=?, GRUPO_EXAME_NOME=?");
	...
	{	
		PreparedStatement ps = getPreparedStatement("Update GRUPO_EXAME set GRUPO_EXAME_ABREV=?, GRUPO_EXAME_NOME=? where GRUPO_EXAME_ID=?");
		ps.setString(1, grupoExame.getGRUPO_EXAME_ABREV());
		ps.setString(2, grupoExame.getGRUPO_EXAME_NOME());
