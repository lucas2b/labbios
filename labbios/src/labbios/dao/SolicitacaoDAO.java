...
public class SolicitacaoDAO extends DatabaseUtil{
	...
	public Solicitacao recuperarSolicitacao(Solicitacao solicitacao) throws ClassNotFoundException, SQLException
	{
		ResultSet rs = getStatement().executeQuery("Select * from SOLICITACAO where SOL_ID="+solicitacao.getSOL_ID());
		rs.next();
		return popularSolicitacao(rs);
	}
